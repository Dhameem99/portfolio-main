            ...
            <div className='contact__content'>
                ...
                <div className='contact__info'>
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>dhameem26@gmail.com</span>

                        <a href="mailto:dhameem26@gmail.com" className='contact__button' target="_blank">Write me 
                    ...
                    <div className='contact__card'>
                        ...
                        <span className='contact__card-data'>Dhameemul Ansari I</span>

                        <a href="https://www.linkedin.com/in/dhameem-ansari-8203a5172/" className='contact__button' target="_blank">Connect me 
                        <i className='bx bx-right-arrow-alt contact__button-icon'></i></a>
                    </div>
